...
def current_context(name: str, kind: str) -> dict:
    return {
        ...
        "parameter_state": [],
        "review_state": {
            "pending_input": {"parameter_patches": 0, "annotations": 0},
            "annotation_clarity": {
                "status": "clear",
                "blocking_count": 0,
                "assumption_count": 0,
            ...
            "preview": {"status": "missing", "provenance": "missing", "mesh": None},
            "parameter_panel": {"status": "current", "exposed_count": 0, "stale_count": 0},
            "refs": {"status": "missing", "count": 0},
        },
        "trust": {
            "authoring_truth": "current",
            "review_preview": "missing",
            "parameters": "current",
            "step": "not_exported",
        ...
        "ready_states": {
            ...
            "review_preview_ready": False,
            "draft_review_ready": False,
            "export_ready": False,
            "handoff_ready": False,
        },
        "layout_facts": {},
        "routing": {
            ...
            "minimum_reads": ["validation/current_context.json", "review/manifest.json", "parameters.yaml", "source/model.py"],
            "minimum_next_reads": ["validation/current_context.json", "review/manifest.json", "parameters.yaml", "source/model.py"],
            "optional_reads": [],
            "required_gates": [
                "preview_checkpoint",
                "source_build_smoke",
            ...
            "forbidden_actions": ["handoff_package"],
            "escalation_reasons": [],
        },
        "gate_plan": {
            "for_next_action": "update_review_preview",
            "required": [
                "preview_checkpoint",
                "source_build_smoke",
                "sync_review_parameters",
            ...
            "optional": ["coverage_audit", "export_step_after_preview_confirmation"],
            "skipped": [
                {
                    "gate": "step_export",
        ...
        "recommended_next_reads": ["validation/current_context.json", "review/manifest.json", "parameters.yaml", "source/model.py"],
    }
